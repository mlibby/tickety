...
cd "${TOP}"
makeDirectory ${TMPDIR}/tickety/bin
copyFileToTmpDir "${OUTPUT_PATH}" "${TMPDIR}/${PACKAGE_TOP_DIR}bin/${OUTPUT_BASENAME}" 0755


# Generate tar file
cd "${TOP}"
rm -f dist/Default/${PLATFORM}/package/tickety.tar
cd ${TMPDIR}
tar -vcf ../../../../dist/Default/${PLATFORM}/package/tickety.tar *
checkReturnCode
